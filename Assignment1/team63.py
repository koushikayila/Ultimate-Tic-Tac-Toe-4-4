class Team63:
	...
	def __init__(self):
		...
		[2,3],[3,3]],[[1,0],[0,1],[1,2],[2,1]],[[1,1],[0,2],[1,3],[2,2]],[[2,0],[1,1],[2,2],[3,1]],[[2,1],[1,2],[2,3],[3,2]]]
		self.blocks = []
		self.boardscore = 0
		self.temp = []
	...
	def update(self, board, new_move, ply):
		...
		#diamond 1
		if (board.board_status[4*x+1][4*y] == board.board_status[4*x][4*y+1] == board.board_status[4*x+2][4*y+1] == \
		board.board_status[4*x+1][4*y+2]) and (board.board_status[4*x+1][4*y] == ply):
			board.block_status[x][y] = ply
			return 1
		#diamond 2
		if (board.board_status[4*x+1][4*y+1] == board.board_status[4*x][4*y+2] == board.board_status[4*x+2][4*y+2] == \
		board.board_status[4*x+1][4*y+3]) and (board.board_status[4*x+1][4*y+1] == ply):
			board.block_status[x][y] = ply
			return 1
		#diamond 3
		if (board.board_status[4*x+2][4*y] == board.board_status[4*x+1][4*y+1] == board.board_status[4*x+3][4*y+1] == \
		board.board_status[4*x+2][4*y+2]) and (board.board_status[4*x+2][4*y] == ply):
			board.block_status[x][y] = ply
			return 1
		#diamond 4
		if (board.board_status[4*x+2][4*y+1] == board.board_status[4*x+1][4*y+2] == board.board_status[4*x+3][4*y+2] == \
		board.board_status[4*x+2][4*y+3]) and (board.board_status[4*x+2][4*y+1] == ply):
			board.block_status[x][y] = ply
			return 1
	...
	def evaluatelinescore(self, board, move):
		...
		y = move[1]/4
		play, other = 0, 0
		if board.board_status[4*x+1][4*y] == self.ply1:
			play+=1
		elif board.board_status[4*x+1][4*y] == self.ply2:
			other+=1
		if board.board_status[4*x][4*y+1] == self.ply1:
			play+=1
		elif board.board_status[4*x][4*y+1] == self.ply2:
			other+=1
		if board.board_status[4*x+2][4*y+1] == self.ply1:
			play+=1
		elif board.board_status[4*x+2][4*y+1] == self.ply2:
			other+=1
		if board.board_status[4*x+1][4*y+2] == self.ply1:
			play+=1
		elif board.board_status[4*x+1][4*y+2] == self.ply2:
			other+=1
		score += self.heuristicMatrix[play][other]
		...
		y = move[1]/4
		play, other = 0, 0
		if board.board_status[4*x+1][4*y+1] == self.ply1:
			play+=1
		elif board.board_status[4*x+1][4*y+1] == self.ply2:
			other+=1
		if board.board_status[4*x][4*y+2] == self.ply1:
			play+=1
		elif board.board_status[4*x][4*y+2] == self.ply2:
			other+=1
		if board.board_status[4*x+2][4*y+2] == self.ply1:
			play+=1
		elif board.board_status[4*x+2][4*y+2] == self.ply2:
			other+=1
		if board.board_status[4*x+1][4*y+3] == self.ply1:
			play+=1
		elif board.board_status[4*x+1][4*y+3] == self.ply2:
			other+=1
		score += self.heuristicMatrix[play][other]
		...
		y = move[1]/4
		play, other = 0, 0
		if board.board_status[4*x+2][4*y] == self.ply1:
			play+=1
		elif board.board_status[4*x+2][4*y] == self.ply2:
			other+=1
		if board.board_status[4*x+1][4*y+1] == self.ply1:
			play+=1
		elif board.board_status[4*x+1][4*y+1] == self.ply2:
			other+=1
		if board.board_status[4*x+3][4*y+1] == self.ply1:
			play+=1
		elif board.board_status[4*x+3][4*y+1] == self.ply2:
			other+=1
		if board.board_status[4*x+2][4*y+2] == self.ply1:
			play+=1
		elif board.board_status[4*x+2][4*y+2] == self.ply2:
		...
		if board.board_status[4*x+1][4*y+2] == self.ply1:
			...
			other+=1
		if board.board_status[4*x+3][4*y+2] == self.ply1:
			play+=1
		elif board.board_status[4*x+3][4*y+2] == self.ply2:
			other+=1
		if board.board_status[4*x+2][4*y+3] == self.ply1:
			play+=1
		elif board.board_status[4*x+2][4*y+3] == self.ply2:
			other+=1
		score += self.heuristicMatrix[play][other]
